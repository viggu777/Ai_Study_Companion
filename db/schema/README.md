...
2. Go to **SQL Editor**
3. Copy the contents of `001_initial_schema.sql` then `002_retrieve.sql` then `003_storage.sql` then `004_embeddings_384.sql` then `005_conversation_summary.sql` then `006_embeddings_gemini_768.sql` (in order)
