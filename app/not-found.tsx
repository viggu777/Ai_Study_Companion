  ...
  return (
    <main className="page-enter flex min-h-screen items-center justify-center bg-stone-100 px-4">
      <div className="w-full max-w-md rounded-2xl border border-stone-200 bg-white p-8 text-center shadow-card">
        <p className="tnum text-5xl font-semibold tracking-tight text-emerald-800">404</p>
        ...
        <Link
          href="/dashboard"
          className="mt-6 inline-flex items-center justify-center gap-2 rounded-lg bg-emerald-700 px-4 py-2 text-sm font-medium text-white shadow-card transition-colors hover:bg-emerald-800"
        >
          Back to dashboard
        </Link>
      </div>
